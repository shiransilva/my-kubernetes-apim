...
cp -RL /home/wso2carbon/temp/* /home/wso2carbon/wso2am-3.1.0/
cp -RL /home/wso2carbon/temp2/* /home/wso2carbon/wso2am-3.1.0/repository/conf/

file="/home/wso2carbon/wso2am-3.1.0/password-tmp"

tmpPass=$( cat $file )
sh /home/wso2carbon/wso2am-3.1.0/bin/ciphertool.sh -Dconfigure -Dpassword=wso2carbon

#if [ "$?" != "0" ]; then
    #rm -rf /home/wso2carbon/wso2am-3.1.0/password-tmp
