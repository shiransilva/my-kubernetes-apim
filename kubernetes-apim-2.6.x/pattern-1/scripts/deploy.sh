...
echoBold 'Creating ConfigSecrets...'
${KUBECTL} create secret generic deployment-conf --from-file=/APIMT/NNINSURANCESUB-248/wso2am-3.1.0/repository/conf/deployment.toml
${KUBECTL} create configmap apim-1-conf-confs --from-file=/APIMT/NNINSURANCESUB-248/wso2am-3.1.0/repository/conf/security/secret-conf.properties
${KUBECTL} create configmap apim-1-conf-jks --from-file=/APIMT/NNINSURANCESUB-248/wso2am-3.1.0/repository/resources/security/wso2test.jks
${KUBECTL} create configmap apim-1-conf-serversh --from-file=/APIMT/NNINSURANCESUB-248/wso2am-3.1.0/bin/wso2server.sh
...
${KUBECTL} create configmap apim-1-conf --from-file=../confs/apim/
#${KUBECTL} create configmap apim-1-conf-tomcat --from-file=../confs/apim/tomcat/
...
#${KUBECTL} create -f ../apim/wso2apim-deployment-1.yaml
#${KUBECTL} create -f ../apim/wso2apim-service-1.yaml
sleep 10s
...
#${KUBECTL} create -f ../ingresses/wso2apim-jag-ingress.yaml
